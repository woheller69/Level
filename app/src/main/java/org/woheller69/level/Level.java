        ...
        if (item.getItemId() == R.id.menu_calibrate) {
            if (rulerView==null){
                ...
                if (rulerCalView == null){
                    ...
                    Drawable rulerCalViewThumb = ContextCompat.getDrawable(context, R.drawable.ic_fine);
                    rulerCalView.setThumb(rulerCalViewThumb);
                    rulerCalViewThumb.setColorFilter(getThemeColor(context, R.attr.colorAccent), PorterDuff.Mode.MULTIPLY);
